                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-3 px-2 text-center">
                                        ...
                                        <img src="{{ asset('storage/foto_profil/'.$transaction->JobOffer->Caretaker->User->profile_img_path) }}" class="profile-pic-md border">
                                        @else
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <p>{{ $transaction->JobOffer->Caretaker->User->nama_depan }} {{ $transaction->JobOffer->Caretaker->User->nama_belakang }}</p>
                                            </div>
                                        </div>
                                        <div class="row">
                                            @if ($transaction->transaction_status == "menunggu")
