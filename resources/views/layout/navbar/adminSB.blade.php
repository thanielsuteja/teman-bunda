...
<body class="bg-dark">
    <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark border-end border-white" style="position: fixed; left:0; top:0; width: 15%; height:100%; z-index: 1;">
