        ...
        <div class="row px-5 mt-3 justify-content-between">
            ...
            <div class="col-md-2">
                ...
                <ul class="list-unstyled">
                    <li><a href="#" class="text-decoration-none link-dark">Tentang</a></li>
                    <li><a href="#" class="text-decoration-none link-dark">Blog</a></li>
            ...
            <div class="col-md-auto">
                ...
                <ul class="list-unstyled">
                    ...
                    <li><a href="#" class="text-decoration-none link-dark">Syarat dan Ketentuan</a></li>
                    <li><a href="#" class="text-decoration-none link-dark">Kebijakan Privasi</a></li>
                </ul>
            </div>
            <div class="col-md-2">
                <h5>Bantuan</h5>
                <ul class="list-unstyled">
                    <li><a href="#" class="text-decoration-none link-dark">Kontak</a></li>
                    <li><a href="#" class="text-decoration-none link-dark">FAQ</a></li>
                </ul>
            </div>
        </div>
        <hr class="m-0">
